  ...
  return (
    <footer className="border-t border-zinc-800/50 bg-[#080808]">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-zinc-500 text-xs max-w-xs leading-relaxed">
              Strategy-driven developer crafting AI-powered, experience-first
              digital solutions.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            {socialLinks.map(({ href, icon: Icon, label }) => (
              <a
                ...
                aria-label={label}
                className="p-2 rounded-lg text-zinc-500 hover:text-zinc-300 hover:bg-zinc-800/60 transition-all duration-200"
              >
                <Icon size={16} />
              </a>
            ))}
        ...
        {/* Divider */}
        <div className="mt-8 pt-8 border-t border-zinc-800/50 flex flex-col sm:flex-row items-center justify-between gap-2 text-zinc-600 text-xs">
          <p>
            &copy; {currentYear} Ian Vince Uriarte. All rights reserved.
          </p>
          <p className="flex items-center gap-1.5">
            Built with{" "}
            <Heart size={11} className="text-rose-500 fill-rose-500" /> using
